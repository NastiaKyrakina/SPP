...
let workshops: Array<WorkshopModel> = [
    ...
    new WorkshopModel(2, 2, 'MEAN Stack: A Complete Guide',
...
If you want to see how easy it is to develop and deploy an application to the cloud using a MEAN stack, IBM offers a simple tutorial for creating a modern application in a MEAN stack.`,
    ...
    new WorkshopModel(3, 3, 'An Introduction to PUG',
...
export class WorkshopService {
    ...
    getArticles(): Array<WorkshopModel> {
        return workshops;
    }
    ...
    getWorkshop(id: number): WorkshopModel {
    ...
    filterWorkshops(tagsId: string, ctg?: string): Array<WorkshopModel> {
    ...
    getCommentOwner(userId: number): UserModel {
